...
{
	/*Returns the number of lines in a string based on newline character count
	 * If string is NULL return -1 instead */
	if (str == NULL) {
		return -1;
	}
...
size_t FRead (FILE* fp, char* buffer, size_t buffsize)
{
	return 0;
}
